            ...
            if (level.indexOf(stageLevel) != -1){
                ...
                if (rateIcon != 'no_rate.svg'){
                    ...
                    if (Number(playScore) >= 900000){
                        ...
                        s.setAttribute(`${stageLevelClass}_rate_s`, '2');
                    };
                    ...
                    if (Number(playScore) >= 930000){
                        ...
                        s.setAttribute(`${stageLevelClass}_rate_s_plus`, '2');
                    };
                    ...
                    if (Number(playScore) >= 950000){
                        ...
                        s.setAttribute(`${stageLevelClass}_rate_ss`, '2');
                    };
                    ...
                    if (Number(playScore) >= 970000){
                        ...
                        s.setAttribute(`${stageLevelClass}_rate_ss_plus`, '2');
                    };
                    ...
                    if (Number(playScore) >= 980000){
                        ...
                        s.setAttribute(`${stageLevelClass}_rate_sss`, '2');
                    };
                    ...
                    if (Number(playScore) >= 990000){
                        ...
                        s.setAttribute(`${stageLevelClass}_rate_sss_plus`, '2');
                    };
                };
                ...
                if (achieveIcon != 'no_achieve.svg'){
                    if (Number(String(achieveIcon).match(/[0-9]+/g)) >= 1){
                        ...
                        s.setAttribute(`${stageLevelClass}_clear`, '2');
                    };
                    ...
                    if (Number(String(achieveIcon).match(/[0-9]+/g)) >= 2){
                        ...
                        s.setAttribute(`${stageLevelClass}_missless`, '2');
                    };
                    ...
                    if (Number(String(achieveIcon).match(/[0-9]+/g)) >= 3){
                        ...
                        s.setAttribute(`${stageLevelClass}_fullcombo`, '2');
                    };
                    ...
                    if (Number(String(achieveIcon).match(/[0-9]+/g)) == 4){
                        ...
                        s.setAttribute(`${stageLevelClass}_allmarvelous`, '2');
                    };
                };
            };
